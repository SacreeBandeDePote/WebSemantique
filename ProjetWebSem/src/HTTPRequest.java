...
public class HTTPRequest {
	...
	public static void main(String[] args) throws IOException {
		...
		parameters.put("text", URLEncoder.encode(
				"Donald Trump, né le 14 juin 1946 à New York, est un homme d'affaires américain. Magnat milliardaire de l'immobilier, il est également animateur de télévision et homme politique",
				"utf-8"));
